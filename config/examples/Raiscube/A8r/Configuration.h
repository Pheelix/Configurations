...
#define STRING_CONFIG_H_AUTHOR "(mphun, Raiscube A8r config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Danny's Printer"
...
// The Raiscube A8r extruder is designed for 1.75mm
