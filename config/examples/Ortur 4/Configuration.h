...
#define DUMMY_THERMISTOR_999_VALUE 110
...
//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 500, 500, 15, 100 } // ...or, set your own edit limits
#endif
...
//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 6000, 5400, 1000, 20000 } // ...or, set your own edit limits
#endif
...
#define Z_PROBE_FEEDRATE_FAST (8*60)*4
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_Z_HOP       6.0        // (mm) Z height of nozzle between leveling points
...
//#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT ((X_BED_SIZE) / 13)    // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT ((Y_BED_SIZE) / 10)    // Y point for Z homing
#endif
